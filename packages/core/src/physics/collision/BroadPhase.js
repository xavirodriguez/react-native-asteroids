...
const boundsPool = [];
class BroadPhase {
    static getShapeBounds(transform, collider) {
        ...
        if (shape.type === Shapes_1.ShapeType.Circle) {
            return {
        ...
        else if (shape.type === Shapes_1.ShapeType.Box) {
            return {
     ...
     */
    static sweepAndPrune(entities, world) {
