...
import { Entity, TransformComponent, Collider2DComponent, CollisionEventsComponent, CollisionManifold } from "../../index";
...
export class CollisionSystem2D extends System {
  ...
  update(world: World, _deltaTime: number): void {
    ...
    if (this._useSpatialGrid && grid) {
      const entityBoundsMap = new Map<Entity, import("../../index").AABB>();
