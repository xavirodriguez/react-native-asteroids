 ...
 *
 * @remarks
 * Implementations are intended to handle the visual representation of the ECS world.
 * While core systems are designed to help minimize allocations, specific renderer
 * implementations may introduce per-frame allocations depending on the underlying
 * platform API (e.g., Canvas, Skia), use of temporary objects for transforms,
 * or internal buffer management.
 */
