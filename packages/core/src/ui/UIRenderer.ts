...
function renderPanel(ctx: CanvasRenderingContext2D, entity: import("../ecs/Entity").Entity, world: World, element: UIElementComponent): void {
...
function renderLabel(ctx: CanvasRenderingContext2D, entity: import("../ecs/Entity").Entity, world: World, element: UIElementComponent): void {
...
function renderButton(ctx: CanvasRenderingContext2D, entity: import("../ecs/Entity").Entity, world: World, element: UIElementComponent): void {
...
function renderProgressBar(ctx: CanvasRenderingContext2D, entity: import("../ecs/Entity").Entity, world: World, element: UIElementComponent): void {
...
function renderImage( _ctx: CanvasRenderingContext2D,  _entity: import("../ecs/Entity").Entity,  _world: World,  _element: UIElementComponent): void {
