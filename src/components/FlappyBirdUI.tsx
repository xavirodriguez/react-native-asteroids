...
import type { FlappyBirdState } from "../games/flappybird/types/FlappyBirdTypes";
...
/**
 * Properties for the {@link FlappyBirdUI} component.
 */
interface FlappyBirdUIProps {
  /** The current game state component containing score and status. */
...
/**
 * Component responsible for rendering the Head-Up Display (HUD) overlay for Flappy Bird.
 */
export const FlappyBirdUI = React.memo(function FlappyBirdUI({
  gameState,
  onRestart,
  onPause,
  isPaused,
...
const Score: React.FC<{ score: number }> = ({ score }) => {
  ...
  return (
    <Animated.View style={animatedStyle}>
      <Text style={[styles.text, { color: "#FFD700" }]}>Score: {score}</Text>
    </Animated.View>
  );
};
