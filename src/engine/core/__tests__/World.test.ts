...
describe("World", () => {
  ...
  describe("Component Management", () => {
    ...
    it("should overwrite a component of the same type", () => {
      const entity = world.createEntity();
      const pos1: PositionComponent = { type: "Position", x: 10, y: 20 };
      const pos2: PositionComponent = { type: "Position", x: 30, y: 40 };

      world.addComponent(entity, pos1);
      world.addComponent(entity, pos2);

      expect(world.getComponent<PositionComponent>(entity, "Position")).toBe(pos2);
    });
  ...
  describe("Querying", () => {
    ...
    it("should return entities with multiple components", () => {
      ...
      world.addComponent(e2, { type: "Position", x: 10, y: 10 } as PositionComponent);
