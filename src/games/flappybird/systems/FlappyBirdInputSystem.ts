...
import { VelocityComponent, PositionComponent } from "../../../engine/types/EngineTypes";
...
/**
 * System that handles player input and bird vertical movement in Flappy Bird.
 */
export class FlappyBirdInputSystem extends System {
  ...
  public update(world: World, deltaTime: number): void {
    ...
    const entities = world.query("Bird", "FlappyInput", "Velocity", "Position");
    ...
    entities.forEach((entity) => {
      ...
      if (input && vel && pos && bird && bird.isAlive) {
        // Sync input state
