...
export const PongEntityFactory = {
  ...
  createPaddle(world: World, side: "left" | "right") {
    ...
    world.addComponent(paddle, { type: "Transform", x, y: PONG_CONFIG.HEIGHT / 2, rotation: 0, scaleX: 1, scaleY: 1 } as TransformComponent);
    ...
    world.addComponent(paddle, { type: "Paddle", side } as any);
    return paddle;
  },
