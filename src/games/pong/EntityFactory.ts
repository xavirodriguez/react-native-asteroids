...
export const PongEntityFactory = {
  createBall(world: World) {
    ...
    world.addComponent(ball, { type: "Position", x: PONG_CONFIG.WIDTH / 2, y: PONG_CONFIG.HEIGHT / 2 } as PositionComponent);
  ...
  createPaddle(world: World, side: "left" | "right") {
    ...
    world.addComponent(paddle, { type: "Position", x, y: PONG_CONFIG.HEIGHT / 2 } as PositionComponent);
