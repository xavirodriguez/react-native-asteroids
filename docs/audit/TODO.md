...
- [ ] Eliminar casts `as unknown as AsteroidsGame` en componentes de React. (Prioridad: P1, Esfuerzo: Medio)
...
### Tareas
- [ ] Optimizar `World.entities` eliminando el sort en cada acceso. (Prioridad: P1, Esfuerzo: Bajo)
- [ ] Investigar migración de Snapshot a SoA (TypedArrays) para reducir GC. (Prioridad: P1, Esfuerzo: Muy Alto)
...
- [ ] Validar esquemas de configuración con Zod en tiempo de carga. (Prioridad: P2, Esfuerzo: Bajo)

## Fase 4: Networking y Sincronización (Media)
### Tareas
- [ ] Protocolo binario para mensajes de red frecuentes. (Prioridad: P2, Esfuerzo: Medio)
- [ ] Capturar estado completo del RNG en snapshots. (Prioridad: P2, Esfuerzo: Bajo)
