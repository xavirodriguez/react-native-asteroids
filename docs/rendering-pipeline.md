...
- **[HIERARCHY_INTERPOLATION]**: Renderers como `CanvasRenderer` y `SkiaRenderer` priorizan las coordenadas `worldX/Y/Rotation` de `PreviousTransformComponent` para una estabilidad visual perfecta en entidades jerárquicas.
